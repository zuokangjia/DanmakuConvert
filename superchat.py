...
class SuperChat:
    def __init__(self, appear_time, disappear_time, user_name, price, btm_box_height, position_y, previous_y, message,
                msg_box_position_x=20, msg_box_position_y=0, msg_space_x=500, msg_space_y=1080, sc_font_size=38, move_time=0.2):
        """
        Args:
    ...
    def draw_upper_box(self, upper_box_color, start_time, end_time, effect):
        ...
        """
        top_box_height = math.ceil(self.sc_font_size + self.sc_font_size*(4.0/5.0) + self.radius/2)
        upper_box = (
    ...
    def write_superchat(self, ass_path):
        ...
        lower_box_position_y = self.position_y + math.ceil(self.sc_font_size + self.sc_font_size*(4.0/5.0) + self.radius/2)
        ...
        pre_lower_box_position_y = pre_upper_box_position_y + math.ceil(self.sc_font_size + self.sc_font_size*(4.0/5.0) + self.radius/2)

        effect_upper_box_move = f"\\move(20,{pre_upper_box_position_y},20,{upper_box_position_y})"
        effect_user_name_move = f"\\move(20,{pre_user_name_position_y},20,{user_name_position_y})"
        effect_superchat_price_move = f"\\move(20,{pre_superchat_price_position_y},20,{superchat_price_position_y})"
        effect_lower_box_msg_move = f"\\move(20,{pre_lower_box_position_y},20,{lower_box_position_y})"
        
        with open(ass_path, "a") as f:
            f.write(self.draw_upper_box(upper_box_color, format_move_time, format_pos_time, effect_upper_box_move) + "\n")
            f.write(self.draw_lower_box(lower_box_color, format_move_time, format_pos_time, effect_lower_box_msg_move) + "\n")
            f.write(self.draw_user_name(user_name_color, format_move_time, format_pos_time, effect_user_name_move) + "\n")
            f.write(self.draw_superchat_price(format_move_time, format_pos_time, effect_superchat_price_move) + "\n")
            f.write(self.draw_superchat_message(format_move_time, format_pos_time, effect_lower_box_msg_move) + "\n")
        ...
        with open(ass_path, "a") as f:
            f.write(self.draw_upper_box(upper_box_color, format_pos_time, end_time, effect_upper_box_position) + "\n")
            f.write(self.draw_lower_box(lower_box_color, format_pos_time, end_time, effect_lower_box_msg_position) + "\n")
            f.write(self.draw_user_name(user_name_color, format_pos_time, end_time, effect_user_name_position) + "\n")
            f.write(self.draw_superchat_price(format_pos_time, end_time, effect_superchat_price_position) + "\n")
            f.write(self.draw_superchat_message(format_pos_time, end_time, effect_lower_box_msg_position) + "\n")